  ...
  return (
    <Fragment>
        ...
        <Container className='m-auto bg-white mt-5 signInWidth pt-3 pb-4 rounded shadow'>
            ...
            <input className='inputStyling pl-2' type="email" placeholder='John123@gmail.com' value={email} onChange= {(e) => setEmail(e.target.value)}/>
            </Col>
            <Col className='m-auto' xl={8}>
            <p className='mb-1'>Password:</p>
            <input className='inputStyling pl-2' type="password" placeholder='*********' value={password} onChange= {(e) => setPassword(e.target.value)}/>
            </Col>
            <Col className='m-auto' xl={8}>
            <Row>
                <Col md={8}  sm={6} xs={4}>
